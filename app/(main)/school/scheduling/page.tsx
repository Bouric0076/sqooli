  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          <h1 className="text-xl font-semibold">Lesson Scheduling</h1>
          <p className="text-sm text-gray-500">
            Manage lesson scheduling for all your teachers
          </p>
        </div>
        <button
          onClick={() => router.push("/school/curriculum")}
...
npm install @fullcalendar/react @fullcalendar/daygrid @fullcalendar/interaction lucide-react
