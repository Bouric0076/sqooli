...
export function MobileView({ schedule,weeks,timeSlots, onEdit, activeWeek, onWeekChange }) {
  ...
  return (
    <div style={{ background: "#f0f2f7", minHeight: "100vh" }}>
      ...
      {/* Week navigator */}
      <WeekNavigator activeWeek={activeWeek} weeks={weeks}  onChange={onWeekChange} />
    ...
    >
      ...
      <div
        style={{
          ...
          borderBottom: `2px solid ${day?.color}`,
          padding: "7px 14px",
          fontSize: 11,
          fontWeight: 700,
          color: day?.color,
      ...
      {subject ? (
        ...
        <div
          onClick={() => onEdit(activeWeek, slot.id, day, null)}
          style={{
            padding: "20px",
            textAlign: "center",
            color: "#aaa",
