  ...
  const sidebarItems = [
    {
      icon: Users,
      label: "Teachers",
      link: "/school/curriculum/cbc/teachers",
    },
    {
      icon: GraduationCap,
      label: "Students",
      link: "/school/curriculum/cbc/students",
    },
    {
      icon: BookOpen,
      label: "Lessons",
      link: "/school/curriculum/cbc/lessons",
    },
    {
      icon: Layers,
      label: "Extra Curricula",
      link: "/school/curriculum/cbc/extra-curricula",
    },
    {
      icon: Calendar,
      label: "Schedule",
      link: "/school/curriculum/cbc/schedule",
    },
  ];
